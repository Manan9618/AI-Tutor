  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const avgScore = quizCount > 0 ? totalScore / quizCount : 0;
  ...
  return (
    <div className="home-page">
      ...
      <div className="stats-cards-grid">
        ...
        <div className="stat-card">
          <h2>{(stats.averageScore).toFixed(2) * 100}%</h2>
          <p>Average Score</p>
        </div>
      </div>
